...
class ActiveOrInactiveDropdown extends StatefulWidget {
  final String hintText;
  final Function(String) onItemSelected;

  const ActiveOrInactiveDropdown({
    super.key,
  ...
  @override
  State<ActiveOrInactiveDropdown> createState() => _ActiveOrInactiveDropdownState();
}

class _ActiveOrInactiveDropdownState extends State<ActiveOrInactiveDropdown> {
