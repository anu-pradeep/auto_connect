...
class TypeOfCustomerDropdown extends StatefulWidget {
  final String hintText;
  final Function(String) onItemSelected;

  const TypeOfCustomerDropdown({
    super.key,
  ...
  @override
  State<TypeOfCustomerDropdown> createState() => _TypeOfCustomerDropdownState();
}

class _TypeOfCustomerDropdownState extends State<TypeOfCustomerDropdown> {
  final TextEditingController _searchController = TextEditingController();
  final FocusNode _focusNode = FocusNode();
  final GlobalKey _fieldKey = GlobalKey();
  OverlayEntry? _overlayEntry;

  final List<String> items = ["Outside", "GP", "Insurance"];
