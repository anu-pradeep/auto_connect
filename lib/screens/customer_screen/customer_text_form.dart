...
class CustomerTextFrom extends StatefulWidget {
  final String formText;
  const CustomerTextFrom({super.key, required this.formText});

  @override
  State<CustomerTextFrom> createState() => _CustomerTextFromState();
}

class _CustomerTextFromState extends State<CustomerTextFrom> {
  @override
