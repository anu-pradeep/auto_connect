...
class SearchableDynamicDropdown extends StatefulWidget {
  final String hintText;
  final Function(String) onItemSelected;
  // final String? Function(String?) validator;

  const SearchableDynamicDropdown({
    super.key,
  ...
  @override
  State<SearchableDynamicDropdown> createState() =>
      _SearchableDynamicDropdownState();
}

class _SearchableDynamicDropdownState extends State<SearchableDynamicDropdown> {
